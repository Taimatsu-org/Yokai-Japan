...
const seqSrc = fs.readFileSync(path.join(srcDir, '13-bottle-sequence.js'), 'utf8');
...
esbuild
  ...
  .catch((err) => { console.error('Error building bottle-sequence.min.js:', err); process.exit(1); });
